...
from sqlalchemy import DateTime, String, ForeignKey, DECIMAL, CheckConstraint, text
...
class Transaction(Base):
    ...
    transaction_date: Mapped[datetime] = mapped_column(DateTime(timezone=False), default=datetime.now, nullable=False)
